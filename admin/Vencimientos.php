                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                            <div class="widget-content widget-content-area br-8">
                                ...
                                <div class="table-responsive">
                                    <table id="vencimiento" class="table dt-table-hover dataTable no-footer" style="width: 100%;" role="grid" aria-describedby="invoice-list_info">
                                        <thead>
                                            <tr role="row">
                                            ...
                                            ?>
                                                <tr role="row">
                                                    ...
                                                    <td class="text-center">
                                                        <span class="badge badge-light-info">Aplazar</span>
                                                    </td>
                                                </tr>
                                            <?php }
                                            ?>
